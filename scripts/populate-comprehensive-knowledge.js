...
class ComprehensiveKnowledgePopulator {
     ...
     */
    addComprehensiveServerDialects() {
        const dialects = [
            {
                name: 'PennMUSH',
                version: '1.8.8',
    ...
    /**
       * Add comprehensive MUSHCODE patterns
       */
    addComprehensiveMushcodePatterns() {
        const patterns = [
            {
                id: 'basic-command',
                name: 'Basic Command',
...
//# sourceMappingURL=populate-comprehensive-knowledge.js.map